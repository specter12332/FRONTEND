...
var usePdf = ({
  ...
  cMapUrl,
  cMapPacked,
  workerSrc = `//cdnjs.cloudflare.com/ajax/libs/pdf.js/${import_pdfjs_dist.version}/pdf.worker.mjs`,
  ...
  const lastPageRequestedRenderRef = (0, import_react.useRef)(null);
  ...
  (0, import_react.useEffect)(() => {
    import_pdfjs_dist.GlobalWorkerOptions.workerSrc = workerSrc;
  }, [workerSrc]);
  (0, import_react.useEffect)(() => {
    ...
    (0, import_pdfjs_dist.getDocument)(config).promise.then(
      (loadedPdfDocument) => {
