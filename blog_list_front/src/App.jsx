...
import LibroLeer from "./services/pages/LibroLeer";
...
export default function App() {
  ...
  const usuario = {
    nombre: "Juan",
    rol: "usuario", // Cambia a "admin" para probar como administrador
  };
    ...
    >
      <div
        style={{
          ...
          inset: 0,
          background: overlay,
          backdropFilter: "blur(1px)", // Menos desenfoque
          zIndex: 1,
      ...
      <div style={{ position: "relative", zIndex: 2 }}>
        {!hideNavbar && <Navbar modoClaro={modoClaro} setModoClaro={setModoClaro} usuario={usuario} />}
        <Routes>
          <Route path="/" element={<Inicio modoClaro={modoClaro} setModoClaro={setModoClaro} usuario={usuario} />} />
          <Route path="/nuevo" element={<NuevoLibro modoClaro={modoClaro} usuario={usuario} />} />
          <Route path="/buscar" element={<BuscarLibros modoClaro={modoClaro} usuario={usuario} />} />
          <Route path="/biblioteca" element={<Biblioteca modoClaro={modoClaro} usuario={usuario} />} />
          <Route path="/login" element={<Login modoClaro={modoClaro} />} />
          <Route path="/register" element={<Register modoClaro={modoClaro} />} />
          <Route path="/perfil" element={<Perfil modoClaro={modoClaro} usuario={usuario} />} />
          <Route path="/libro/:id" element={<LibroCompleto modoClaro={modoClaro} usuario={usuario} />} />
